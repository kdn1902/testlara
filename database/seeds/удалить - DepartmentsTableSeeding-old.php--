...
class DepartmentsTableSeeding extends Seeder
{
    ...
    public function run()
    {
             ...
             Department::create(['name' => 'Финансовая дирекция','department_number'=>3,'department_parent'=>1]);
             Department::create(['name' => 'Исполнительная дирекция','department_number'=>2,'department_parent'=>1]);
             
             Department::create(['name' => 'Департамент ИТ технологий','department_number'=>10,'department_parent'=>2]);
             ...
             Department::create(['name' => 'Юридический департамент','department_number'=>20,'department_parent'=>2]);
             ...
             Department::create(['name' => 'Транспортный департамент','department_number'=>30,'department_parent'=>2]);
             ...
             Department::create(['name' => 'Финансовый департамент','department_number'=>40,'department_parent'=>3]);
